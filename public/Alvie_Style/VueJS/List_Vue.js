...
new Vue({
    ...
    methods: {
        onLoad: function () {
            axios({
                method: 'put',
                url: 'http://' + window.location.host + '/api/modules/list/income',
                data: this.$data,
                headers:
                    {
        ...
        foo: function (data) {
            ...
            if (this.$data.data_all.entry_type = "income") {
                $('#click11i').hide();
                $("#click11ii").show()
            }
        ...
        OnSubmit: function () {
            ...
            axios({
                method: 'put',
                url: 'http://' + window.location.host + '/api/modules/entries/filter_income',
                data: obj,
                headers:
                    {
                        'Content-Type': 'application/json',
